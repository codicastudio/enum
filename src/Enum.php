...
namespace codicastudio\Enum;

use ReflectionClass;
use JsonSerializable;
use Illuminate\Support\Str;
use codicastudio\Enum\Casts\EnumCast;
use Illuminate\Support\Facades\Lang;
use Illuminate\Support\Traits\Macroable;
use codicastudio\Enum\Contracts\EnumContract;
use codicastudio\Enum\Contracts\LocalizedEnum;
use Illuminate\Contracts\Support\Arrayable;
use Illuminate\Contracts\Database\Eloquent\Castable;
use codicastudio\Enum\Exceptions\InvalidEnumKeyException;
use codicastudio\Enum\Exceptions\InvalidEnumMemberException;
...
abstract class Enum implements EnumContract, Castable, Arrayable, JsonSerializable
{
     ...
     * @return void
     *
     * @throws \codicastudio\Enum\Exceptions\InvalidEnumMemberException
     */
     ...
     * @return static
     *
     * @throws \codicastudio\Enum\Exceptions\InvalidEnumKeyException
     */
